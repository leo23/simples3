"""Streaming with :mod:`simpleoss` via :mod:`poster.streaminghttp`

Usage::

    >>> bucket = StreamingOSSBucket("leo-test", access_key="tphpxphfwvi8pkyknidum012", secret_key="ZQNJzf4QJRkrH4nrqsK6eOh0fmE=")
...
class StreamingMixin(object):
    def put_file(self, key, fp, acl=None, metadata={}, progress=None,
        ...
        """Put file-like object or filename *fp* on OSS as *key*.
...
class StreamingOSSBucket(default_stream_mixin, OSSBucket): pass
